...
import android.helper.utils.PreferenceHelper;
...
public class AppException extends Exception implements UncaughtExceptionHandler {
    ...
    public final static String DEFAULT_SAVE_LOG_FILE_PATH = Environment
            ...
            + File.separator
            + android.helper.app.BaseApplication.getLogTag()
...
//    }
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (!handleException(ex) && mDefaultHandler != null) {
            ...
            if (android.helper.app.BaseApplication.isDebug()) {
                // Sleep一会后结束程序
                try {
                    Thread.sleep(3000);
    ...
    public boolean saveErrorLog(Throwable ex) {
        ...
        FileWriter fw = null;
        PrintWriter pw = null;
        Context context = android.helper.app.BaseApplication.getContext();
        try {
            //判断是否挂载了SD卡
...
//                }.start();
    ...
    public PackageInfo getPackageInfo() {
        ...
        try {
            info = android.helper.app.BaseApplication.getContext().getPackageManager().getPackageInfo(android.helper.app.BaseApplication.getContext().getPackageName(), 0);
