 ...
 * <p>
 * <uses-permission android:name="android.permission.GET_ACCOUNTS" android:maxSdkVersion="22" /><!--获取账号信息的权限-->
 * <uses-permission android:name="android.permission.AUTHENTICATE_ACCOUNTS" android:maxSdkVersion="22" /><!--添加账号的权限-->
 * </p>
 * 2：必须注册清单文件，且添加resource的资源文件，详细可见类中的描述
 * <p>
 * <service android:name=".test.app.account.AccountService" android:enabled="true" android:exported="true">
 ...
 * <p>
 * <provider android:name=".test.app.account.SyncProvider" android:authorities="com.android.app.account.authority" />
 * </P>
 ...
 * </P>
 * 5：新建广播类，用来接收账号拉活的通知，必须实现过滤：com.android.app.lifecycle 标记， 且必须建立广播类：com.android.account.LifecycleReceiver
 */
