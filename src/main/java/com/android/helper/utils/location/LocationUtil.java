...
public class LocationUtil implements BaseLifecycleObserver {
     ...
     * 数据回调的监听
     */
    // private AMapLocationListener mAMapLocationListener = new
     ...
     */
    // public static void getAddressForLatitude(Context context, double latitude,
    // double longitude, String searchType, ReGeocodeResultListener
    // reGeCodeResultListener) {
    // try {
    // // 设置地理编码（正向和逆向）查询监听
    ...
    // // 设置监听
    // geocodeSearch.setOnGeocodeSearchListener(new
     ...
     */
    // public static void getLocationForAddress(Context context, String address,
    // String city, GeocodeResultListener resultListener) {
    // try {
     ...
     * 计算两个地方之间的距离，这个是直线距离
     */
    // public void calculationDistance(Context context, LatLonPoint start,
    // LatLonPoint end) {
    // try {
    // // 1:构建搜索对象
    // DistanceSearch distanceSearch = new DistanceSearch(context);
    // // 2：设置搜索监听
    // distanceSearch.setDistanceSearchListener(new
    ...
    // });
    // // 3:构建搜索参数的对象
    // DistanceSearch.DistanceQuery distanceQuery = new
    ...
    // if
    // (!mListPermission.contains("android.permission.ACCESS_BACKGROUND_LOCATION"))
    // {
    // // android 30 后台定位
    ...
    // // mListPermission.add(Manifest.permission.ACCESS_BACKGROUND_LOCATION);//
    // 后台定位权限
    // mListPermission.add("android.permission.ACCESS_BACKGROUND_LOCATION");//
    // 后台定位权限
    // }
    // }
    // }
    ...
    //
    // if (mType == 1) {
    // mPermissionBuilder = new RxPermissionsUtil.Builder(mFragmentActivity,
    // permissionArray);
    // } else if (mType == 2) {
    // mPermissionBuilder = new RxPermissionsUtil.Builder(mFragment,
    // permissionArray);
    // }
    //
